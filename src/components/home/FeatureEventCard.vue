<template>
  <v-dialog v-model="dialog" width="800">
    ...
    <v-card
      ...
      v-if="dialog"
      class
      style="border-radius:5px ; background-color: yellow"
      :class="this.$vuetify.theme.dark == true?'black darken-3':'white'"
    >
      ...
      <v-card-text class="pb-5 pt-0">
        ...
        <v-btn
          ...
          dark
          style="text-transform: capitalize; background-color: transparent; border: 2px solid #fae500;"
        >Event Page</v-btn>
        ...
        <v-btn
          ...
          class="ma-0 elevation-0 my-2 mr-3"
          dark
          style="text-transform: capitalize; background-color: transparent; border: 2px solid #14f000;"
        ...
        <v-btn
          ...
          class="ma-0 elevation-0 my-2 mr-3"
          dark
          style="text-transform: capitalize; background-color: transparent; border: 2px solid #0066eb;"
        >Meetup Page</v-btn>
        <v-btn
          ...
          class="ma-0 elevation-0 my-2 mr-3"
          dark
          style="text-transform: capitalize; background-color: transparent; border: 2px solid #f51800;"
        >YouTube Live</v-btn>
      </v-card-text>

      <v-divider></v-divider>

      <v-card-actions :class="this.$vuetify.theme.dark == true?'black accent-3':'grey lighten-3'">
        <v-spacer></v-spacer>
