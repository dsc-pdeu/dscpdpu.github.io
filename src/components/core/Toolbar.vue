<template>
  <v-app-bar app hide-on-scroll fixed clipped-left :class="this.$vuetify.theme.dark == true?'black':'white'" :style="
      this.$vuetify.theme.dark ? {boxShadow:'0 2px 6px 0 rgba(0,0,0,.12), inset 0 -1px 0 0 #080808'}
    ...
    <v-toolbar-title class="google-font px-0" style="width:450px;">
      <router-link
        to="/"
        class="google-font"
      ...
      >
      Developer Student Club | PDPU</router-link>
    </v-toolbar-title>
    <v-spacer></v-spacer>
  ...
  methods: {
    ...
    darkMode() {
      ...
      if (this.$vuetify.theme.dark) {
        metaThemeColor.setAttribute("content", "#080808");
      } else {
