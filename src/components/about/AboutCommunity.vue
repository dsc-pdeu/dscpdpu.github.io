    ...
    <v-container fluid class="py-0 my-0 mt-2 mb-5">
        <v-row class="py-0 my-0" align="center">
            ...
            <v-col md="8" sm="12" cols="12" class="py-0 my-0">
                <!-- {{datas}} -->
                <p class="google-font mt-0" style="font-size:110%">A Developer Students Club is a Google recognized student body at a college which directly reports to Google for their activities and is supported by the tech giant. A DSC conducts workshops, seminars and other fun activities which help the students connect with Google.</p>
                <br>
