<template>
  <v-content class="ma-0">
    ...
    <v-container fluid class="pa-0 pt-5 my-0" >
      <v-row justify="center" align="center" style="background:#0066eb"  class="py-5 my-0">
    ...
    <v-container fluid class="pa-0 py-0" v-if="showFeatureEventStatus">
      <v-row justify="center" align="center" class="py-5" :class="this.$vuetify.theme.dark == true?'#080808':'grey lighten-4'">
        <v-col md="12" sm="11" lg="10" xs="12" class="py-0">
          <featureEvents />
        </v-col>
      </v-row>
